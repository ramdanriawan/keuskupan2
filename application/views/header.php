	...
	<script>
		$(document).ready(function() {
			$("a[href *='#']").click(function(event){
				...
				$("body, html").animate({
					scrollTop: top - $(".scroll").height() - 30
					...
					<div class="sidebar-category sidebar-category-visible">
						<div class="category-content no-padding">
							<ul class="navigation navigation-main navigation-accordion">
								...
								<li><a href="setting"><i class="glyphicon glyphicon-wrench"></i> <span>Setting</span></a></li>
								<li><a href="report"><i class="glyphicon glyphicon-filter"></i> <span>Report</span></a></li>
